 ...
 * @since 1.0.0
 */
public interface UserCommentService extends IBaseService<UserCommentMapper, UserComment> {
     ...
     * @param content
     */
    void addComment(final Long userId, final String user, final String nickName , final String avatar, final String content);
}