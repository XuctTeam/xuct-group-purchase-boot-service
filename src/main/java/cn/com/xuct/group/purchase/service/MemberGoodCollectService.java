 ...
 * @since 1.0.0
 */
public interface MemberGoodCollectService extends IBaseService<MemberGoodCollectMapper, MemberGoodCollect> {
     ...
     * @param goodId
     */
    void collect(final Long memberId, final Long goodId);
     ...
     * @return
     */
    List<MemberGoodResult> list(final Long memberId);
}